...
export const alt = "Exclusive drop on Fan Engage";
...
export default async function DropOpengraphImage({
  ...
  // drop param is a human-readable slug; decode for display
      ...
      >
        ...
        >
          <div style={{ maxWidth: 720 }}>
            Premium fans get first access to exclusive drops on Fan Engage.
          </div>
          <div
            style={{
              display: "flex",
